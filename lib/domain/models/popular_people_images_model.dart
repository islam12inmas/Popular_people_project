class PopularPeopleImagesModel {
  PopularPeopleImagesModel({
      this.id, 
      this.profiles, List<dynamic>? images,});

  PopularPeopleImagesModel.fromJson(dynamic json) {
    id = json['id'];
...
PopularPeopleImagesModel copyWith({  num? id,
  List<Profiles>? profiles,
}) => PopularPeopleImagesModel(  id: id ?? this.id,
  profiles: profiles ?? this.profiles, images: [],
);
