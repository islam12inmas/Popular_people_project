class PopularPeopleDataModel {
  PopularPeopleDataModel({
      this.adult, 
      this.alsoKnownAs, 
      this.biography, 
      this.birthday, 
  ...
  PopularPeopleDataModel.fromJson(dynamic json) {
    adult = json['adult'];
  ...
  num? popularity;
  String? profilePath;
PopularPeopleDataModel copyWith({  bool? adult,
  List<String>? alsoKnownAs,
  String? biography,
  String? birthday,
  String? deathday,
  ...
  num? popularity,
  String? profilePath,
}) => PopularPeopleDataModel(  adult: adult ?? this.adult,
